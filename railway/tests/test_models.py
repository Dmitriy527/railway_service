...
class TrainTypeModelTest(TestCase):
    ...
    def test_train_type_unique(self):
        """Тест унікальності назви типу поїзда"""
...
class OrderModelTest(TestCase):
    ...
    def test_order_auto_now_add(self):
        """Тест автоматичного встановлення created_at"""
        self.assertIsNotNone(self.order.created_at)
...
class TicketModelTest(TestCase):
    ...
    def test_ticket_unique_constraint(self):
        """Тест унікальності комбінації cargo, seat, journey"""
        with self.assertRaises(IntegrityError):
    ...
    def test_ticket_different_journey_allows_duplicate(self):
        """Тест, що ті самі місця можна забронювати в різних подорожах"""
    ...
    def test_validate_seat_valid(self):
        """Тест валідації правильних значень місць"""
        try:
    ...
    def test_validate_seat_invalid_cargo_too_low(self):
        """Тест валідації неправильного вагона (занадто низьке значення)"""
    ...
    def test_validate_seat_invalid_cargo_too_high(self):
        """Тест валідації неправильного вагона (занадто високе значення)"""
        with self.assertRaises(ValueError) as context:
            Ticket.validate_seat(
                cargo=10,
                seat=20,
    ...
    def test_validate_seat_invalid_seat_too_low(self):
        """Тест валідації неправильного місця (занадто низьке значення)"""
        with self.assertRaises(ValueError) as context:
            Ticket.validate_seat(
                cargo=3,
                seat=0,
    ...
    def test_validate_seat_invalid_seat_too_high(self):
        """Тест валідації неправильного місця (занадто високе значення)"""
        with self.assertRaises(ValueError) as context:
            Ticket.validate_seat(
                cargo=3,
                seat=50,
    ...
    def test_ticket_clean_valid(self):
        """Тест методу clean() з правильними даними"""
        try:
            self.ticket.clean()
        except ValueError:
    ...
    def test_ticket_clean_invalid(self):
        """Тест методу clean() з неправильними даними"""
        invalid_ticket = Ticket(
            cargo=10,  # поїзд має тільки 5 вагонів
            seat=15,
            journey=self.journey,
            order=self.order
        )
...
class ModelRelationshipsTest(TestCase):
    """Тести для перевірки зв'язків між моделями"""
    ...
    def test_cascade_delete_journey(self):
        """Тест каскадного видалення подорожі з квитками"""
        ticket = Ticket.objects.create(
            cargo=1,
            seat=1,
            journey=self.journey,
